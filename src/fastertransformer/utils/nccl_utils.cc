...
#ifdef PRINT_NCCL_INFO
    FT_LOG_INFO("%s args: data_type: %d, data_size: %d, num_ranks: %d", __PRETTY_FUNCTION__, nccl_data_type, data_size, nccl_param.world_size_);
#endif  // PRINT_NCCL_INFO
#endif
